...
<div class="row">
  <div class="column" style="background-color:#FFFFFF;">
    ...
    <p><img src="https://github.com/JuditSastre/test_blog/blob/master/assets/images/ines1.jpg?raw=true" width="50%" height="50%">Enamorada de la Ciencia, los viajes y los buenos bares (y de cualquier combinación de ellos). Graduada en Bioquímica, máster en Biofísica y eterna aprendiz de las bases físicas que dirigen los procesos biológicos.<br> <b>#BeerLover</b></p>
  </div>
  <div class="column" style="background-color:#FFFFFF;">
